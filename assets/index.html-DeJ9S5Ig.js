import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as a,b as e}from"./app-C4rPT73i.js";const i={},l=e(`<h2 id="远程连接问题" tabindex="-1"><a class="header-anchor" href="#远程连接问题"><span>远程连接问题</span></a></h2><figure><img src="https://shaohui-jin.github.io/picx-images-hosting/blog/Linux/001.231mqnozjx.webp" alt="" width="800" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>修改登录客户端，即本地计算机的设置。 运行gpedit.msc打开本地组策略编辑器，依次展开“计算机配置”-&gt;“管理模板”-&gt;“系统”-&gt;“凭据分配”，选择设置项： 加密 Oracle 修正 然后右键编辑，改为 启用，保护级别为 易受攻击，确定。设置完成后即可正常远程。</p><h2 id="查看网卡配置" tabindex="-1"><a class="header-anchor" href="#查看网卡配置"><span>查看网卡配置</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> /etc/sysconfig/network-scripts/
